...
.. py:function:: plot_variable_importance(variable_importance: pandas.DataFrame, mode='minmax', color='C0', cmap='flare', alpha=1, **kwargs)

.. py:function:: roc_plot_bundle(list_fpr, list_tpr, mean_fpr=np.linspace(0, 1, 100), plot_all=False, plot_beam=True, cmap='inferno', plot_mean=True, c='C0', label_iter=None, mode='std', label='', **args)
