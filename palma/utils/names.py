...
RIGHT_NAMES = [
    ...
    # Benjamin Franklin is famous for his projects in electricity and the invention of the lightning rod.
    "franklin",
    ...
    # Margaret Hamilton - Director of the Software Optimizerering Division of the MIT Instrumentation Laboratory, which developed on-board flight software for the Apollo space program. https:#en.wikipedia.org/wiki/Margaret_Hamilton_(scientist)
    "hamilton",
    ...
    # Sir Mokshagundam Visvesvaraya - is a notable Indian engineer.  He is a recipient of the Indian Republic's highest honour, the Bharat Ratna, in 1955. On his birthday, 15 September is celebrated as Optimizerer's Day in India in his memory - https:#en.wikipedia.org/wiki/Visvesvaraya
    "visvesvaraya",
    ...
    # Chien-Shiung Wu - Chinese-American projectal physicist who made significant contributions to nuclear physics. https:#en.wikipedia.org/wiki/Chien-Shiung_Wu
    "wu",
...
def get_random_name() -> str:
    ...
    """
    name = "{}_{}{}".format(
        LEFT_NAMES[randint(0, len(LEFT_NAMES)-1)],
        RIGHT_NAMES[randint(0, len(RIGHT_NAMES)-1)],
        randint(0, 10)
    )
